...
{
	ros::init(argc, argv, "vin_s_gpu_estimator");
	ros::NodeHandle n("~");
	...
	if(argc != 3)
	{
		printf("please intput: rosrun vin_s_gpu kitti_odom_test [config file] [data folder] \n"
			   "for example: rosrun vin_s_gpu kitti_odom_test "
			   "~/catkin_ws/src/vin_s_gpu-Fusion/config/kitti_odom/kitti_config00-02.yaml "
