...
int main(int argc, char** argv)
{
	...
	if(argc != 3)
	{
		printf("please intput: rosrun vin_s_gpu kitti_gps_test [config file] [data folder] \n"
			   "for example: rosrun vin_s_gpu kitti_gps_test "
			   "~/catkin_ws/src/vin_s_gpu-Fusion/config/kitti_raw/kitti_10_03_config.yaml "
